    ...
    <div className='pt-16 pb-28 px-5 lg:px-[10%] map-bg'> 
        ...
        <div>
            <form action="" className='flex-col flex gap-3 mt-7 font-serif'>
                ...
                <input type="text" placeholder='Enter Registered Business Name' className='lg:w-[50%] text-black py-3 rounded px-5 focus:outline-none focus:ring-0 '/>
                <label htmlFor="businessName" className='font-sansSerif text-sm'>Business Location</label>
                <input type="text" placeholder='Select Company Type' className='lg:w-[50%] text-black py-3 rounded px-5 focus:outline-none focus:ring-0 '/>
                <label htmlFor="businessName" className='font-sansSerif text-sm'>Annual Turnover</label>
                <input type="text" placeholder='Annual Turnover' className='lg:w-[50%] text-black py-3 rounded px-5 focus:outline-none focus:ring-0 '/>
                ...
                <textarea rows={4}  placeholder='Enter Registered Business Name' className='lg:w-[50%] text-black py-3 rounded px-5 focus:outline-none focus:ring-0 '/>
