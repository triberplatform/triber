...
export default function BusinessDetail() {
  ...
  useEffect(() => {
    const fetchDealRoomProfile = async () => {
      if ((currentStep === 3 || currentStep === 4) && !dealRoomProfile && !dealRoomLoading && id) {
        const token = localStorage.getItem("token");
        if (!token) return;
        
        setDealRoomLoading(true);
        try {
          const response = await getDealRoomProfile(token,Array.isArray(id) ? id[0] : id );
  ...
  const nextImage = () => {
    if (activeGalleryTab === 'photos' && dealRoomProfile?.businessPhotos && dealRoomProfile.businessPhotos.length > 0) {
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-12 py-6 lg:py-10 text-xs gap-6 lg:gap-0">
              ...
              <div className="lg:col-span-4 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Employees: {business.numOfEmployees || "Not provided"}</span>
                </div>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>Established: {business.yearEstablished || "Not provided"}</span>
                </div>
                <div className="flex items-center gap-2">
                  <MdOutlinePermIdentity className="text-mainGreen text-lg" />
                  <span>Legal Entity: {business.businessLegalEntity ? formatBusinessTypeToSentence(business.businessLegalEntity) : "Not provided"}</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="lg:col-span-4 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                  <LiaIndustrySolid className="text-mainGreen text-lg" />
                  <span>Business Stage: {business.businessStage || "Not provided"}</span>
                </div>
              </div>
            </div>
                      ...
                      <div className="bg-zinc-800 px-4 py-2 rounded-lg">
                        <div className="flex items-center">
                          <div className="mr-4">
                            ...
                            <p className="text-2xl font-bold">{fundabilityData.score || 0}/100</p>
                          </div>
                          ...
                          <div className="space-y-4">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-sm">{fundabilityData.legalName || business.businessName || "Not provided"}</p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-400">Registration</p>
                                <p className="text-sm">{fundabilityData.companyRegistration || business.businessLegalEntity || "Not provided"}</p>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-sm">{fundabilityData.yearsOfOperation || business.yearEstablished || 0} years</p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-400">Company Size</p>
                                <p className="text-sm">{fundabilityData.companySize || business.numOfEmployees || 0} employees</p>
                              </div>
                            </div>
                            
                            <div>
                              <p className="text-xs text-gray-400">Industry</p>
                              <p className="text-sm">{fundabilityData.industry || business.industry || "Not provided"}</p>
                            </div>
                            ...
                            <div>
                              ...
                              <p className="text-sm">{fundabilityData.city && fundabilityData.country ? 
                                ...
                                business.location || "Not provided"}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <tr key={item.publicId} className="border-b border-gray-800">
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-2">
                                ...
                                <span>{item.investor?.companyName || "Unknown"}</span>
                              </div>
                            </td>
                            <td className="px-4 py-3">
                              <span 
                            ...
                            <td className="px-4 py-3 max-w-xs">
                              <p className="truncate">{item.proposal || "No proposal details"}</p>
                            </td>
                          </tr>
                        ))}
                      </tbody>
        ...
        case 4: // Documents Tab
          return (
            <div className="bg-mainBlack rounded-lg shadow-lg p-6">
              ...
              ) : dealRoomProfile && dealRoomProfile.businessDocuments && dealRoomProfile.businessDocuments.length > 0 ? (
                <div className="space-y-4">
              ...
              {/* Photo Gallery */}
              {dealRoomProfile && dealRoomProfile.businessPhotos && dealRoomProfile.businessPhotos.length > 0 && (
                <div className="mt-10">
                  <h3 className="text-lg font-medium text-mainGreen mb-4">Photo Gallery</h3>
                  ...
                  {/* Lightbox */}
                  {lightboxOpen && dealRoomProfile && dealRoomProfile.businessPhotos && (
                    <div 
                      className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4"
                      onClick={closeLightbox}
                    >
              ...
              {dealRoomProfile && dealRoomProfile.proofOfBusiness && (
                <div className="mt-10">
                  <h3 className="text-lg font-medium text-mainGreen mb-4">Proof of Business</h3>
