    ...
    <div className="flex flex-col gap-4 ">
      ...
      <div className="grid grid-cols-2  gap-6">
        ...
        <div className="bg-mainBlack p-3 flex flex-col gap-2">
            ...
            <Link href={'fundability-test/select-startup'} className="text-center my-3">      <span className="text-center my-3"><button className="text-center bg-black shadow-sm shadow-white py-1 px-5">Take Test</button></span></Link>
        </div>
        <div className="bg-mainBlack p-3 flex flex-col gap-2">
