          ...
          <div className="bg-mainBlack p-6">
            <div className="grid items-center grid-cols-10">
              <div className="col-span-7">
                ...
                Thank you for showing interest in [Business Name]. Your proposal has been sent to the business owner. We will review your offer and reach out via email to discuss the next steps..
                </p>
              </div>
