  ...
  return (
    ...
    <div className="bg-black min-h-screen p-8 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-mainGreen text-2xl font-semibold mb-4">Terms of Use</h2>
        <p className="mb-4">By using our website (www.TRIBER.com) or our services, you are agreeing to the terms and conditions provided here.</p>
        
        <p className="mb-4">Our website has been designed to connect buyers/investors and sellers of small and medium-sized businesses through the process of automated searching, shortlisting and contacting prospects.</p>
        ...
        <h2 className="text-mainGreen text-2xl font-semibold mb-4 mt-6">Liability</h2>
        <p className="mb-4">If you have a dispute with one or more other users of our website, you release TRIBER from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, arising out of or in any way connected with such disputes.</p>
        
        <p className="mb-4">TRIBER will not be liable for any direct, special, indirect, incidental, consequential or punitive damages or any other damages whatsoever, whether in an action of contract, statute, tort (including, without limitation, negligence) or otherwise, relating to the use of this website.</p>
        
        <h2 className="text-mainGreen text-2xl font-semibold mb-4 mt-6">Intellectual Property</h2>
        <p className="mb-4">Any program, publication, design, product, process, software, technology, information, know-how, or idea described in this website may be the subject of other rights, including other intellectual property rights, which are owned by TRIBER or other interested parties and are not licensed to you hereunder. Any transfer, sale, distribution, reproduction, copying or modification of any material contained on this website (in whole or in part) is strictly prohibited.</p>
        
        <p className="mb-4">As a condition of your use of this website, you agree not to upload or post any material that infringes the copyright, trademark or other intellectual property rights of any third party.</p>
        
        <h2 className="text-mainGreen text-2xl font-semibold mb-4 mt-6">Rights of TRIBER</h2>
        <p className="mb-4">TRIBER reserves the right to edit or delete or suspend any advertised profile or user, if we, in our opinion, believe the user is misusing the platform, or using it for any other purpose than intended, or has provided false/misleading information to users they connect with or on their profile or has behaved offensively with TRIBER or any other users, with or without notice. Under these circumstances, purchase made on TRIBER will not be refundable. You agree that TRIBER shall not be liable to you or to any third party for any modification, suspension or discontinuation of the service.</p>
        ...
        <div className="mt-8 p-4 border border-mainGreen rounded">
          <p className="text-center">By using TRIBER, you hereby, unconditionally and irrevocably confirm that you have read terms and conditions and agree to abide by them.</p>
        </div>
      </div>
    </div>
    </>
